      ...
      <Suspense fallback={<PageLoading />}>
        <Switch>
          ...
          <Route
            ...
            path="/compte"
            render={() =>
              connectedUser == null ? <Redirect to="/connexion" /> : <Compte />
            }
          />
          <Route
            exact
            path="/sinscrire"
            render={() =>
              connectedUser == null ? <Signup /> : <Redirect to="/" />
            }
          />
          <Route
            exact
            path="/connexion"
            render={() =>
              connectedUser == null ? <Login /> : <Redirect to="/" />
            }
          />
          <Route
            exact
            path="/deconnexion"
            render={() =>
              connectedUser == null ? <Redirect to="/" /> : <Logout />
            }
          />
          <Route
            exact
            path="/reinit-mdp"
            render={() =>
              connectedUser == null ? <ResetPassword /> : <Redirect to="/" />
            }
          />
